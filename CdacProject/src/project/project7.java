...
public class project7 extends JFrame implements ActionListener{
	...
	project7()
	{
		...
		b2=new JButton("Doctor",i2);
		b3=new JButton("Reception",i3);
		b6=new JButton("Cross",i6);
        ...
        l0.setFont(new Font("Courier New", Font.BOLD, 30)); 
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getActionCommand().contentEquals("Admin"))
		{
			setVisible(false);
		...
		else if(ae.getActionCommand().contentEquals("Doctor")) 
		{
			setVisible(false);
			project9 ob=new project9();
			 setSize(1950,1950);
		}
		else if(ae.getActionCommand().contentEquals("Reception")) 
		{
			setVisible(false);
		...
		else if(ae.getActionCommand().contentEquals("Cross")) 
		{
			setVisible(false);
			setSize(1950,1950);
		}
