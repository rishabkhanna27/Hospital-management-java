...
public class projectrec2 extends JFrame implements ActionListener{
	JLabel li,la,lb,lc,ld,le,lf,lg,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16;
	...
	projectrec2()
	{
		...
		b1.setBounds(1000,850,100,50);
		b2.setBounds(750,850,100,50);
		...
		l15.setBounds(400,700,200,20);
		l16.setBounds(1200,700,200,20);
		
		
		
		
		la.setBounds(1,1,2000,70);
		le.setBounds(10,300,300,70);
		lb.setBounds(10,370,300,70);
		lc.setBounds(10,440,300,70);
		li.setBounds(10,510,300,70);
		ld.setBounds(10,580,300,70);
		lf.setBounds(10,650,300,70);
		lg.setBounds(10,720,300,70);
        ...
        ld.setText("Receptionist");
        ld.setOpaque(true);
        
        li.setFont(new Font("Courier New", Font.BOLD, 30)); 
	...
	try
	{
		...
		else if(ae.getActionCommand().contentEquals("Submit")) 
		{
			...
			stm.executeUpdate("insert into recptionist values(null,'"+Date+"','"+ID+"','"+Name+"','"+ag+"','"+Gender+"','"+addr+"','"+Number+"','"+Status+"','"+Blood+"','"+email+"','"+user+"','"+pass+"')");
			stm.executeUpdate("insert into enter values(null,'"+user+"','"+pass+"')");
			projectrec2 ob=new projectrec2();
		}
