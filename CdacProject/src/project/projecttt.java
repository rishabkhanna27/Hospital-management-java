...
public class projecttt extends JFrame implements ActionListener{
	...
	projecttt()
	{
		...
		ImageIcon i7 = new ImageIcon("D:\\Java project\\ICONS\\doctor.png");
		...
		l6=new JLabel();
		l7=new JLabel();
		b1=new JButton("Add Patient",i1);
		b2=new JButton("Update Patient",i2);
		b3=new JButton("Delete Patient",i3);
		b4=new JButton("Search Patient",i4);
		b5=new JButton("View Patient",i5);
		b7=new JButton("View Doctor",i7);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getActionCommand().contentEquals("Add Patient"))
		{
			setVisible(false);
			projecttt1 ob=new projecttt1();
			 setSize(1950,1950);

		}
		else if(ae.getActionCommand().contentEquals("Update Patient")) 
		{
			setVisible(false);
			projecttt3 ob=new projecttt3();
			 setSize(1950,1950);
		}
		else if(ae.getActionCommand().contentEquals("Delete Patient")) 
		{
			setVisible(false);
			projecttt4 ob=new projecttt4();
			 setSize(1950,1950);
		}
		else if(ae.getActionCommand().contentEquals("Search Patient")) 
		{
			setVisible(false);
			projecttt5 x= new projecttt5();
			 setSize(1950,1950);
		}
		else if(ae.getActionCommand().contentEquals("View Patient")) 
		{
			setVisible(false);
			projecttt2 ob=new projecttt2();
			 setSize(1950,1950);
		}
		else if(ae.getActionCommand().contentEquals("View Doctor")) 
		{
			setVisible(false);
			projecttt6 ob=new projecttt6();
			 setSize(1950,1950);
		}
