...
public class projecttt1 extends JFrame implements ActionListener{
	JLabel la,lb,lc,ld,le,lf,lg,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14;
	...
	try
	{
		...
		else if(ae.getActionCommand().contentEquals("Submit")) 
		{
			...
			String Disease=t9.getText();
			String Ward=t10.getText();
			//System.out.println(Ward);
			int Wardd=Integer.parseInt(Ward);
		//	System.out.println(Wardd);
			
			
			stm.executeUpdate("insert into patient values(null,'"+Date+"','"+ID+"','"+Name+"','"+ag+"','"+Gender+"','"+addr+"','"+Number+"','"+Status+"','"+Disease+"','"+Wardd+"')");
			setVisible(false);
